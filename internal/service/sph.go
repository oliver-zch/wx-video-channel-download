...
// FeedResponse channels feed API 响应
...
type Feedinfo struct {
	...
	Decodekey       uint64        `json:"decodeKey"`
}
...
// FetchVideoProfileWithShareUrl 解析分享链接，获取视频信息
func FetchVideoProfileWithShareUrl(shareUrl string, cookie string) (*FeedResponse, error) {
	...
	// 从 playable_url 提取 generalToken 和 exportId
	generalToken := ""
	exportId := ""
...
// CleanVideoURL 清理视频 URL，只保留 encfilekey 和 token 参数
